...
const translations = {
  en: {
    ...
    tierLabel: 'Tier {n}', shotsRetry: '{n} shots left — try again!',
    round: 'Round',
  ...
  it: {
    ...
    tierLabel: 'Livello {n}', shotsRetry: '{n} colpi — riprova!',
    round: 'Livello',
  ...
  ro: {
    ...
    tierLabel: 'Nivel {n}', shotsRetry: 'în {n} încercări — mai încearcă!',
    round: 'Rundă',
  ...
  de: {
    ...
    tierLabel: 'Stufe {n}', shotsRetry: '{n} Schüsse — versuch es nochmal!',
    round: 'Runde',
  ...
  fr: {
    ...
    tierLabel: 'Palier {n}', shotsRetry: '{n} tirs — réessaie !',
    round: 'Manche',
  ...
  zh: {
    ...
    tierLabel: '第{n}级', shotsRetry: '还剩{n}次机会—再试一次！',
    round: '轮次',
