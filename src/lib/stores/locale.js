...
const translations = {
  en: {
    ...
    levelLocked: 'Complete earlier levels to unlock!',
  ...
  it: {
    ...
    levelLocked: 'Completa i livelli precedenti per sbloccare!',
  ...
  ro: {
    ...
    levelLocked: 'Completează nivelele anterioare pentru a debloca!',
