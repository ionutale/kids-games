...
- [x] `fanfare.mp3` + 4 loops present in `static/sounds/`, each ≤ 400 KB, provenance recorded in docs/free-assets.md — **code + fallbacks shipped; binaries pending manual CC0 sourcing** (kenney.nl / pixabay downloads are interactive)
...
> **Status (2026-08-23):** complete — binaries sourced and shipped.
