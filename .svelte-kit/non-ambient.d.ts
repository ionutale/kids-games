...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/games" | "/games/animal-quiz" | "/games/emoji-warcraft" | "/games/memory" | "/games/paint" | "/games/pop" | "/games/puzzle" | "/games/soccer" | "/games/sorting" | "/games/splash" | "/games/stickers" | "/games/tower-defense";
		RouteParams(): {
		...
		LayoutParams(): {
			...
			"/games/emoji-warcraft": Record<string, never>;
		...
		Pathname(): "/" | "/games/animal-quiz" | "/games/emoji-warcraft" | "/games/memory" | "/games/paint" | "/games/pop" | "/games/puzzle" | "/games/soccer" | "/games/sorting" | "/games/splash" | "/games/stickers" | "/games/tower-defense";
